IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || configatron.intercom.app_id

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = configatron.intercom.app_secret
  ...
  #
  config.api_key = configatron.intercom.api_key
